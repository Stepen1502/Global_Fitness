<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="login.aspx.cs" Inherits="GLOBEL.login" %>
...
<body>
    ...
    <div class="contact_section layout_padding">
      <div class="container-fluid">
        <div class="contact_text"><b>ADMIN</b> <span class="contact_us_text">LOGIN</span></div>
          ...
          <div class="row">
            ...
            <div class="col-md-6">
              <div class="mail_section">
                  ...
                  <asp:TextBox ID="txt_name" runat="server" input type="text" class="mail_text" placeholder="Name" name="Name"></asp:TextBox>
                  ...
                  <asp:Button ID="Button1" runat="server" class="send_bt" Text="LOGIN" BackColor="#0066FF" BorderColor="#333333" ForeColor="White" Height="52px" Width="98px" OnClick="Button1_Click" />
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-4 col-sm-6">
            ...
            <p class="footer_lorem_text2">Fax: +91 638318050</p>
