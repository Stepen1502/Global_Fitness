<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="registercus.aspx.cs" Inherits="GLOBEL.registercus" %>
       ...
       <h1 style="font-family:'Times New Roman', Times, serif;font-size:50px;color:white;text-align:center;">GLOBAL FITNESS</h1>
        <div class="menu_main">
          <ul>
           ...
           <%-- register form div --%>
            <h1 style="text-align:center;color:dodgerblue;font-size:50px;padding:20px;">CUSTOMER REGISTARTION</h1>
            <%--<div class="col-md-6" style="text-align:center;">--%>
              <div class="mail_section"style="text-align:center;padding:100px;">
                  ...
                  <asp:TextBox ID="txt_email" runat="server" input type="" class="mail_text" placeholder="Email" name="Email"></asp:TextBox>
                  <asp:TextBox ID="txt_phone" runat="server"  input type="" class="mail_text" placeholder="Mobile Number" name="Phone"></asp:TextBox>
                  <asp:TextBox ID="txt_password" runat="server" input type="" class="mail_text" placeholder="Password" name="Password"></asp:TextBox>
                  ...
                  <br />
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <div class="Locations_text"><img src="images/map-icon.png"><span class="map_icon">Kallakurichi</span></div>
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-4 col-sm-6">
            ...
            <p class="footer_lorem_text2">Fax: +91 9876543210</p>
