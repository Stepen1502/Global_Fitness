<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="employee.aspx.cs" Inherits="GLOBEL.employee" %>
 ...
 <h1 style="font-family:'Times New Roman', Times, serif;font-size:50px;color:white;text-align:center;">GLOBAL FITNESS</h1>
    ...
    <div class="contact_section layout_padding">
      <div class="container-fluid">
        <div class="contact_text"><b>EMPLOYEE</b> <span class="contact_us_text">LOGIN</span></div>
          ...
          <div class="row">
            ...
            <div class="col-md-6">
              <div class="mail_section">
                  ...
                  <asp:Button ID="Button1" runat="server" class="send_bt" Text="LOGIN" BackColor="#0066FF" BorderColor="Black" ForeColor="White" Height="47px" Width="100px" OnClick="Button1_Click" />
