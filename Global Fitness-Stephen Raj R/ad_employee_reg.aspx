<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ad_employee_reg.aspx.cs" Inherits="GLOBEL.ad_employee_reg" %>
      ...
      <div class="container">
       <h1 style="font-family:'Times New Roman', Times, serif;font-size:50px;color:white;text-align:center;">GLOBEL FITNESS</h1>
        ...
        <br />
           ...
           <%-- register form div --%>
            <h1 style="text-align:center;color:dodgerblue;font-size:50px;padding:20px;">EMPLOYEE REGISTARTION</h1>
        <%--<div class="col-md-6" style="text-align:center;">--%>
              <div class="mail_section"style="text-align:center;padding:100px;">
                  <%--  <input type="" class="mail_text" placeholder="Name" name="Name">--%>
                  <asp:TextBox ID="txt_emp_name" runat="server" input type="" class="mail_text" placeholder="Name" name="Name" ></asp:TextBox>
                  <%--<input type="" class="mail_text" placeholder="Email" name="Email">--%>
                  <asp:TextBox ID="txt_emp_email" runat="server" input type="" class="mail_text" placeholder="Email" name="Email"></asp:TextBox>
                  <asp:TextBox ID="txt_emp_phone" runat="server"  input type="" class="mail_text" placeholder="Mobile Number" name="Phone"></asp:TextBox>
                  <asp:TextBox ID="txt_emp_password" runat="server" input type="password" class="mail_text" placeholder="Password" name="Password"></asp:TextBox>
                  <%--                <input type="" class="mail_text" placeholder="Phone Number" name="Phone Number">--%>
                  <asp:Button ID="Button1" runat="server"  class="send_bt" Text="LOGIN" BackColor="#0066FF" Font-Size="Medium" ForeColor="White" Height="48px" OnClick="Button1_Click" Width="101px"  />
                  <br />
                  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                  <br />
                  <br />
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-4 col-sm-6">
            ...
            <p class="footer_lorem_text2">Fax: +91 6383180750</p>
